...
<img src="https://img.shields.io/badge/Hard-0/150 (0.0%)-red?style=for-the-badge&logo=leetcode" />
    ...
    <div align="center">
        <p><b>0.0%</b></p>
        <div style="width:90%;max-width:400px;height:10px;background:#1a1b27;border-radius:10px;border:1px solid #2f3542;">
            <div style="width:0%;height:100%;background:linear-gradient(90deg,#ff7675,#ffffff);border-radius:10px;"></div>
        </div>
    </div><br>
    <div align="center">
<img src="https://leetcard.jacoblin.cool/8AdxLDYG0y?theme=dark&ext=heatmap" />
</div>
